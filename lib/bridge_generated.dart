...
abstract class Interface {
  Future<int> getCount({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kGetCountConstMeta;
...
class InterfaceImpl implements Interface {
  final InterfacePlatform _platform;
  factory InterfaceImpl(ExternalLibrary dylib) =>
      InterfaceImpl.raw(InterfacePlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory InterfaceImpl.wasm(FutureOr<WasmModule> module) =>
      InterfaceImpl(module as ExternalLibrary);
  InterfaceImpl.raw(this._platform);
  Future<int> getCount({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_get_count(port_),
      parseSuccessData: _wire2api_u64,
      constMeta: kGetCountConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
...
class InterfacePlatform extends FlutterRustBridgeBase<InterfaceWire> {
  InterfacePlatform(ffi.DynamicLibrary dylib) : super(InterfaceWire(dylib));
...
class InterfaceWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  InterfaceWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  InterfaceWire.fromLookup(
  ...
  void wire_get_count(
    ...
    return _wire_get_count(
      port_,
    );
  }

  late final _wire_get_countPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_get_count');
  late final _wire_get_count =
      _wire_get_countPtr.asFunction<void Function(int)>();
